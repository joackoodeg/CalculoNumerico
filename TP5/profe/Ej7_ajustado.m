...
%% x vs t
[sx1, dsx1, ddsx1] = funcion_spline(t1,x1, 0, 0);
[sx2, dsx2, ddsx2] = funcion_spline(t2,x2, 0, 0);
...
%% y vs t
[sy1, dsy1, ddsy1] = funcion_spline(t1,y1, 0, 0);
[sy2, dsy2, ddsy2] = funcion_spline(t2,y2, 0, 0);
